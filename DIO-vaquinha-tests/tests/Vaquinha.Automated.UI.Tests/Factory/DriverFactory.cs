...
namespace Vaquinha.AutomatedUITests
{
	public class DriverFactory
    {
        ...
        public DriverFactory()
        {
            ...
            //nescessario baixar drive e colocar na pasta em questão (so criar e alterar pasta e caminho drive disponivel em "https://chromedriver.chromium.org/downloads")
            ChromeDriverService service = ChromeDriverService.CreateDefaultService("D:\\driverChorme");
